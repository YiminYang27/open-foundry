...
def agent_speak(session: Session, agent: Agent, ctx: ForumContext,
                llm: ClaudeCLI) -> str:
...
def agent_execute(session: Session, agent: Agent, ctx: ForumContext,
                  task: dict, llm: ClaudeCLI) -> str:
